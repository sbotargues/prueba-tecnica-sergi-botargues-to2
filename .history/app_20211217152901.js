...
.then((jsonObj)=>{
    ...
    for(var x=0;x<jsonObj;x++){
         temp.toLowerCase() = parseFloat.toLowerCase()(jsonObj[x].toLowerCase().song_name.toLowerCase()).toLowerCase()
         jsonObj[x].toLowerCase().song_name.toLowerCase() = temp.toLowerCase();
